...
const imageBefore = document.querySelector('.slider__picture--before');
const imageAfter = document.querySelector('.slider__picture--after');
const switcher = document.querySelector('.switcher');
const switcherRange = document.querySelector('.switcher__range');
const slider = document.querySelector('.example__');
const activeImage = 'slider__picture--active';
