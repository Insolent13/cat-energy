...
document.body.addEventListener('mousemove',function(e){
  ...
  x -= document.querySelector('.example__slider').getBoundingClientRect().left;
...
function scrollIt(x){
    let transform = Math.max(0,(Math.min(x,document.querySelector('.example__slider').offsetWidth)));
    document.querySelector('.example__slider').style.width = transform+"px";
